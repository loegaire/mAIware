...
window.electronAPI.onScanResult((scanResult) => {
  ...
  // --- NEW/FIXED: Call all UI helper functions ---
  ...
  drawCallGraph(scanResult.graphData); // <-- FIXED: Use graphData from scanResult
});

/**
 * NEW: Clears all dynamic result data to prepare for the next scan.
 */
